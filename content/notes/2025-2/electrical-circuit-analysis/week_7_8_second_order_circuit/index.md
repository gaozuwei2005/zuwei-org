...
- **欠阻尼** $\alpha < \omega_0$：则令阻尼频率 $\omega_d = \sqrt{\omega_0^2 - \alpha^2}$，那么 $s_{1,2} = -\alpha \pm j \omega_d$，得到 $i(t) = A_1 e^{s_1t} + A_2e^{s_2t} = e^{-at} (A_1\cos\omega_dt + A_2\sin\omega_dt) = K e^{-at} \cos(\omega_dt + \theta)$，其中 $\displaystyle K = \sqrt{A_1^2 + A_2^2},\ \theta = -\arctan \frac{A_2}{A_1}$.S

![](attachments/Pasted%20image%2020260417154924.png)

Conclusion:
![](attachments/Pasted%20image%2020260421080500.png)

# 8.4 无源激励 RLC 并联电路

![](attachments/Pasted%20image%2020260421083317.png)
在这里，$\displaystyle \alpha = \frac{1}{2RC},\ \omega_0 = \frac{1}{\sqrt{LC}}$，其余的结论和 RLC 并联电路相同。

![](attachments/Pasted%20image%2020260421085809.png)

# 8.5 串联 RLC 电路的阶跃响应

![](attachments/Pasted%20image%2020260421090936.png)

![](attachments/Pasted%20image%2020260421091011.png)
