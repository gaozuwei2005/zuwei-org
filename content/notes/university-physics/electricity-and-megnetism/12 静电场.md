...
## 库仑定律
- 库仑定律：电荷 $q_2$ 受电荷 $q_1$ 的作用力 $\displaystyle \mathbf F_{21} = \frac{kq_1q_2}{r_{21}^2} \mathbf{e}_{r21} = \frac{q_1q_2}{4 \pi \epsilon_0 r_{21}^2} \mathbf{e}_{r21}$，其中 $k \approx 9 \times 10^9 N·m^2/C^2, \epsilon_0 \approx 8.85 \times 10^{-12} C^2/(N·m^2)$
