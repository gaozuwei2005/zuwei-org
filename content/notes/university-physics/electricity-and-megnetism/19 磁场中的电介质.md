...
- **H 的环路定理**：由 $\displaystyle \oint_L \boldsymbol B · \mathrm d\boldsymbol r = \mu_0 \left (\sum I_{0in} + I'_{in} \right )$，令磁场强度 $\displaystyle \boldsymbol H = \frac{\boldsymbol B}{\mu_0} - \boldsymbol M$，那么得到 $\displaystyle I_{0in} = \oint_L \boldsymbol H · \mathrm d \boldsymbol r$.
