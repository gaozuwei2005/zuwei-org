...
$$\begin{aligned}
\frac{\mathrm d\boldsymbol{L}}{\mathrm dt} &= \sum_i \boldsymbol{M}_i \\
&= \sum_i \boldsymbol{r}_i \times \left( \boldsymbol{F_i} 
 + \sum_{j \ne i} \boldsymbol{f}_{ij} \right) \\
&= \sum_i \boldsymbol{r}_i \times \boldsymbol{F_i} + \sum_{i \ne j}  (\boldsymbol{r}_i \times \boldsymbol{f}_{ij} + \boldsymbol{r}_j \times \boldsymbol{f}_{ji}) \\
&= \sum_i \boldsymbol{r}_i \times \boldsymbol{F_i} + \sum_{i \ne j}  
(\boldsymbol{r}_i - \boldsymbol{r}_j) \times \boldsymbol{f}_{ij}
 \end{aligned}$$
